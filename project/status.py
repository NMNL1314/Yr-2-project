...
class PlayerStatusPage(QWidget):
    def __init__(self, name):
        # super(PlayerStatusPage, self).__init__(name)
        super().__init__()
        self.name = name
        self.init_ui()
    ...
    def init_ui(self):
        ...
        self.label_player_name = QLabel(f'Player: ,{self.name}')
    ...
    def update_status(self, name, icon_path, total_play_time, current_streak, longest_streak, score, time):
...
if __name__ == '__main__':
    ...
    player_status_page = PlayerStatusPage('User234')
